        ...
        if (customProperties != null) {
            for (Map<String, ?> property : customProperties) {
                ...
                if (property.containsKey("string")) {
                    setCustom(item, propertyName, property.get("string"));
                } else if (property.containsKey("int")) {
                    // Json stores things as Floats.  Convert to integer here.
                    setCustom(item, propertyName, ((Float) property.get("int")).intValue());
                } else if (property.containsKey("float")) {
                    try {
                        setCustom(item, propertyName, property.get("float"));
                    } catch (Exception ex) {
                        // probably a string.
                    ...
                    setCustom(item, propertyName, property.get("bool"));
